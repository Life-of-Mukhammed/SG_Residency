...
export default function ManagerSprintPage() {
  ...
  const T = {
    title: { uz: 'Sprint menejeri', ru: 'Sprint menejeri', en: 'Sprint menejeri' },
    subtitle: { uz: 'Chorak, oy nomlari va sprint vazifalarini boshqaring', ru: 'Chorak, oy nomlari va sprint vazifalarini boshqaring', en: 'Chorak, oy nomlari va sprint vazifalarini boshqaring' },
    customTasks: { uz: "Sprint vazifalari", ru: "Sprint vazifalari", en: "Sprint vazifalari" },
    tip: { uz: "Bu yerda chorak va oy nomlarini o'zgartirib, asoschilar ko'radigan sprint tuzilmasini moslashtirasiz.", ru: "Bu yerda chorak va oy nomlarini o'zgartirib, asoschilar ko'radigan sprint tuzilmasini moslashtirasiz.", en: "Bu yerda chorak va oy nomlarini o'zgartirib, asoschilar ko'radigan sprint tuzilmasini moslashtirasiz." },
    addTask: { uz: "Vazifa qo'shish", ru: "Vazifa qo'shish", en: "Vazifa qo'shish" },
    editTask: { uz: 'Vazifani tahrirlash', ru: 'Vazifani tahrirlash', en: 'Vazifani tahrirlash' },
    quarter: { uz: 'Chorak nomi', ru: 'Chorak nomi', en: 'Chorak nomi' },
    month: { uz: 'Oy nomi', ru: 'Oy nomi', en: 'Oy nomi' },
    taskTitle: { uz: 'Vazifa nomi', ru: 'Vazifa nomi', en: 'Vazifa nomi' },
    description: { uz: 'Tavsif', ru: 'Tavsif', en: 'Tavsif' },
    taskTitleReq: { uz: 'Vazifa nomi kerak', ru: 'Vazifa nomi kerak', en: 'Vazifa nomi kerak' },
    updated: { uz: 'Yangilandi', ru: 'Yangilandi', en: 'Yangilandi' },
    added: { uz: "Qo'shildi", ru: "Qo'shildi", en: "Qo'shildi" },
    deleted: { uz: "O'chirildi", ru: "O'chirildi", en: "O'chirildi" },
    failed: { uz: 'Xatolik yuz berdi', ru: 'Xatolik yuz berdi', en: 'Xatolik yuz berdi' },
    noTasks: { uz: "Hozircha vazifa yo'q", ru: "Hozircha vazifa yo'q", en: "Hozircha vazifa yo'q" },
    by: { uz: 'muallif', ru: 'muallif', en: 'muallif' },
    cancel: { uz: 'Bekor qilish', ru: 'Bekor qilish', en: 'Bekor qilish' },
    saveChanges: { uz: "O'zgarishlarni saqlash", ru: "O'zgarishlarni saqlash", en: "O'zgarishlarni saqlash" },
    saveNames: { uz: 'Nomlarni saqlash', ru: 'Nomlarni saqlash', en: 'Nomlarni saqlash' },
    namesSaved: { uz: 'Nomlar saqlandi', ru: 'Nomlar saqlandi', en: 'Nomlar saqlandi' },
    addQuarter: { uz: "Chorak qo'shish", ru: "Chorak qo'shish", en: "Chorak qo'shish" },
  };
